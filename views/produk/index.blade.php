        ...
        <div id="side_nav">
            <div class="sideNavCategories">
                ...
                <ul class="category departments">
                    <li class="header">{{ trans('content.shop_front.shop.category') }}</li>
                ...
                <ul class="category collection">
                    <li class="header">{{ trans('content.shop_front.shop.collection') }}</li>
                ...
                <div class="show_no opsi-item">
                    <div>                    
                        <select class="itemselect" id="show" data-rel="{{URL::current()}}">
                            <option value="0">{{ trans('content.shop_front.shop.product') }}</option>
                            <option value="12" {{Input::get('show')==12?'selected="selected"':''}}>12 {{ trans('content.shop_front.shop.cart.item') }}</option>
                            <option value="24" {{Input::get('show')==24?'selected="selected"':''}}>24 {{ trans('content.shop_front.shop.cart.item') }}</option>
                        </select>
                    </div>
                </div>
            </div>
